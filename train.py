...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default= 'darknet53.conv.74', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='cfg/yolov3.cfg', help='*.cfg path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/yolo.date', help='*.date path')
